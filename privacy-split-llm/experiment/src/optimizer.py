...
def add_optimizer_params(parser: argparse.ArgumentParser):
    ...
    parser.add_argument('--adam_beta2', default=0.999, type=float, help='adam beta2 term')
    
    parser.add_argument('--scheduler', default='linear', type=str,
                        choices=['cosine', 'inv_sqrt', 'dev_perf', 'constant', 'linear', 'cycle'],
                        help='lr scheduler to use.')

    parser.add_argument('--max_step', type=int, default=1000, help='upper epoch limit')
    parser.add_argument('--warmup_max_step', type=int, default=1000, help='upper epoch limit')

    parser.add_argument('--max_epoch', type=int, default=1, help='max epoch of training')

    parser.add_argument('--warmup_step', type=int, default=500, help='upper epoch limit')
